...
public class ReadPropFile {
	...
	public static void main(String[] args) throws IOException {
		...
		if (browserName.equals("chrome")) {
			...
			System.setProperty("webdriver.chrome.driver", "D:\QA Softwares\Drivers\geckodriver");
			driver = new FirefoxDriver();
		}
		else if(browserName.equals("IE")){
			System.setProperty("webdriver.chrome.driver", "D:\QA Softwares\Drivers\internetexplorerdriver");
